  ...
  const loginWithGoogle = async () => {
    ...
    try {
      ...
      if (err.code === 'auth/popup-blocked') {
        throw new Error("Popup blocked by your browser. Please unblock popups or open the application in a new tab using the link below to authenticate successfully.");
      }
      throw err;
    }
  };
